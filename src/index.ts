...
//         modal.showModal()
//     } else {
//         console.warn("The provided modal was'nt found. ID: ", id)
//     }
// }
...
//         modal.close()
//     } else {
//         console.warn("The provider modal wasn't found. ID: ", id)
//     }
// }
...
if (newProjectBtn) {
    // newProjectBtn.addEventListtener("click", () => {toggleModal("new-project-modal", "show")})
...
//             // toggle Modal("new-project-modal, "close")
//             toggleModal("new-project-modal", "close")
//             console.log(projectsManager.list)
//         }
//     })
// } else {
//     console.warn("The projectForm was'nt found, Check the ID!")
// }
    ...
    projectForm.addEventListener("submit", (e) => {
        ...
        if(handler == "new-project-form-submit-btn") {
            ...
            const projectData: IProject = {
                name: formData.get("name") as string,
                description: formData.get("description") as string,
                cost: formData.get("status") as ProjectStatus,
                status: formData.get("userRole") as UserRole,
                finishDate: new Date (formData.get("finishDate") as string),
            }
...
We can write if (newProjectBtn !== null) that means if newProjectBtn in not null.
